...
import { useEventListener, useSize, useThrottleEffect } from "ahooks";
...
export const useThree2 = () => {

  const renderer = useRef<typeof CSS3DRenderer>()
  ...
  const objects = useRef<typeof CSS3DObject[]>([]);
  const targets = useRef<{
    table: THREE.Object3D<THREE.Object3DEventMap>[],
    sphere: THREE.Object3D<THREE.Object3DEventMap>[],
    helix: THREE.Object3D<THREE.Object3DEventMap>[],
    grid: THREE.Object3D<THREE.Object3DEventMap>[]
  ...
  const init = () => {
    ...
    for (let i = 0; i < table.length; i += 5) {
      ...
      element.className = 'three-element';
  ...
  function transform(this: any, targets: THREE.Object3D<THREE.Object3DEventMap>[], duration: number) {
    TWEEN.removeAll();
    ...
    return ()=>{
      ...
      switch(cout){
        case 1:
          ...
          break;
        case 2:
          transform( targets.current.helix, 2000);
          break;
        case 3:
